    ...
    <div className="mt-20 p-10 mx-auto max-w-2xl text-center">
      ...
      <StyledSlider {...settings}>
        <div className=" items-center    max-w-2xl  h-40   drop-shadow-xl ">
          <img className="w-full h-full rounded-lg" src="https://cdn.pixabay.com/photo/2017/10/10/07/48/hills-2836301_640.jpg" alt="Top10" />
        ...
        <div className="w-full h-40 drop-shadow-xl ">
          <img className="w-full h-full object-center transition duration-300 ease-in-out hover:scale-110 rounded-md" src="https://cdn.pixabay.com/photo/2017/04/09/09/56/avenue-2215317_640.jpg" alt="Top10" />
          <h1>3</h1>
        </div>
      </StyledSlider>
    </div>
